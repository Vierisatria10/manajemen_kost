...
<div class="wrapper wrapper-login wrapper-login-full p-0">
		<div class="login-aside w-50 d-flex flex-column align-items-center justify-content-center text-center bg-dark">
			...
			<h1 class="title fw-bold text-white mb-3"><img src="<?= base_url('assets/img/saluv_kost.png') ?>" style="background-image: transparent;" alt=""></h1>
			<p class="subtitle text-white op-7">Sistem Informasi Manajemen Kost (Saluv Kost)</p>
		</div>
		<div class="login-aside w-50 d-flex align-items-center justify-content-center bg-white">
			<div class="container container-login container-transparent animated fadeIn">
				<h3 class="text-center">Sign In To Saluv Kost</h3>
				...
				<div class="login-form">
					...
					<div class="form-group form-action-d-flex mb-3">
						...
						<button type="submit" class="btn btn-dark col-md-5 float-right mt-3 mt-sm-0 fw-bold">Sign In</button>
					</div>
