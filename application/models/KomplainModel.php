...
class KomplainModel extends CI_Model{
    ...
    var $table = 'tbl_komplain';
    var $column_order = array(null, 'id_komplain', 'id_penghuni', 'nama_penghuni', 'nomor_kamar', 'jenis_komplain', 'lama_keresahan', 'permasalahan');
    var $column_search = array('id_komplain', 'nama_penghuni');
